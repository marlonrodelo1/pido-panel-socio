...
const ICONS = {
  ...
  esperando:<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polyline points="20 6 9 17 4 12"/><polyline points="20 11 12 19 9 16"/></svg>,
  ...
  rendimiento: <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><line x1="3" y1="20" x2="21" y2="20"/><line x1="6" y1="20" x2="6" y2="12"/><line x1="11" y1="20" x2="11" y2="6"/><line x1="16" y1="20" x2="16" y2="14"/><line x1="21" y1="20" x2="21" y2="9"/></svg>,
}

const ITEMS = [
  { id: 'rider-pedidos',     label: 'Pedidos',    icon: 'pedidos' },
  { id: 'rider-mapa',        label: 'Mapa',       icon: 'mapa' },
  { id: 'rider-esperando',   label: 'Esperando',  icon: 'esperando' },
  { id: 'rider-chat',        label: 'Chat',       icon: 'chat' },
  { id: 'rider-rendimiento', label: 'Rendimiento',icon: 'rendimiento' },
]
