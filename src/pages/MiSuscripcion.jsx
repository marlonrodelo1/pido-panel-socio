...
// Mismo plan que el restaurante: 39 €/mes, con meses gratis al arrancar.
        ...
        <>
          <div style={{ ...ds.card, padding: 22, marginBottom: 14 }}>
            ...
            <div style={{ display: 'flex', alignItems: 'baseline', gap: 6 }}>
              <span style={{ fontFamily: type.mono, fontSize: 32, fontWeight: 800, color: colors.ink }}>39</span>
            ...
            <div style={{ fontSize: type.sm, color: colors.stone, marginTop: 6 }}>
              2 meses gratis al empezar · Cancela cuando quieras.
            </div>
            {sub?.fecha_proximo_pago && activa && (
          ...
          {activa ? (
            ...
            >
              {yendo ? 'Redirigiendo a Stripe…' : 'Suscribirme · 39 €/mes (2 meses gratis)'}
            </button>
          )}
        </>
      )}
